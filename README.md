...
- <img height="12" width="12" src="https://fixparser.dev/favicon.ico" alt="FIXParser Logo" /> **[FIXParser]([https://github.com/fireproof-storage/mcp-database-server](https://gitlab.com/logotype/fixparser))** - A modern FIX Protocol engine for AI-powered trading agents
