...
- <img height="12" width="12" src="https://winston-app-production-public.s3.amazonaws.com/winston-ai-logo-white-blue.svg" alt="Winston.AI Logo" /> **[Winston AI](https://github.com/gowinston-ai/winston-ai-mcp-server)** - AI detector MCP server with industry leading accuracy rates in detecting use of AI in text and images. The [Winston AI](https://gowinston.ai) MCP server also offers a robust plagiarism checker to help maintain integrity.
